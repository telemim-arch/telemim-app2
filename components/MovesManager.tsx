...
export const MovesManager: React.FC<MovesManagerProps> = ({ 
  ...
  const handleExportPDF = (move: MoveRequest) => {
      alert(`Gerando arquivo PDF da Ordem de Serviço ${move.id}...\n(Funcionalidade simulada para este ambiente)`);
  };
                   ...
                   <div className="flex items-center gap-2">
                      ...
                      {userRole === UserRole.ADMIN ? (
                         <select
                            ...
                            className={`text-[10px] uppercase font-bold py-0.5 px-1 rounded border outline-none cursor-pointer ${
                                move.driverConfirmation === 'CONFIRMED' ? 'bg-green-50 text-green-700 border-green-200' :
                   ...
                   <div className="flex items-center gap-2">
                      ...
                      {userRole === UserRole.ADMIN ? (
                         <select
                            ...
                            className={`text-[10px] uppercase font-bold py-0.5 px-1 rounded border outline-none cursor-pointer ${
                                move.vanConfirmation === 'CONFIRMED' ? 'bg-green-50 text-green-700 border-green-200' :
